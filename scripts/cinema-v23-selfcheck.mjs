...
for(const s of ["WorkflowEntrypoint","CinemaBatchWorkflow","step.do","generate base-morning","/api/cinema/batch/start","/api/cinema/batch/status","/api/cinema/batch/public","confirm_cost!==true","successRetention"] )if(!background.includes(s))errors.push(`cinema background missing ${s}`);
...
console.log("CINEMA V23 BACKGROUND SELFCHECK PASSED: 9 clips -> 27 flows, durable Workflow, authenticated playback, explicit-cost guard");
