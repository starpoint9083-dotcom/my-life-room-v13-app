...
for(const s of ["WorkflowEntrypoint","CinemaBatchWorkflow","step.do","generate ${slot}","/api/cinema/batch/start","/api/cinema/batch/status","/api/cinema/batch/public","confirm_cost!==true","successRetention"] )if(!background.includes(s))errors.push(`cinema background missing ${s}`);
