...
const specs=[
 ...
 ["service-worker-v22","/sw.js",b=>b.includes("my-life-room-v22-shell")&&b.includes('const BUILD="visualfix1"')&&b.includes('const PATCH="cleanup2"')&&b.includes("/core-runtime-v21.js")&&b.includes("/continuity-runtime-v22.js")]
];
...
for(let attempt=1;attempt<=12;attempt++){
 ...
 if(last.every(x=>x.ok)){console.log("DEPLOYMENT VERIFIED P2 V22 CONTINUITY + VISUAL CLEANUP2");process.exit(0)}
