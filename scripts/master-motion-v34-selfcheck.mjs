...
for(const s of ["/master-motion-v36.js?v=36","/master-motion-v35.js?v=35","/master-motion-v34.js?v=34","window.masterMotionV36||window.masterMotionV35||window.masterMotionV34||window.masterMotionV33||window.masterMotionV32","playForSlot","playTransition","mappedFallbackSlots","mode===\"day\""]){if(!program.includes(s))errors.push(`V30/V34 planner bridge missing ${s}`)}
...
console.log("P2 V34 SELFCHECK PASSED: 8 masters structurally cover all 50 slots + 6 transitions + V36/V35/V33/V32 fallback + free-only");
