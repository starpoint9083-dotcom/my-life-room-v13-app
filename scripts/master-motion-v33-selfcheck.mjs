...
for(const s of ["/master-motion-v34.js?v=34","/master-motion-v33.js?v=33","/master-motion-v32.js?v=32","window.masterMotionV34||window.masterMotionV33||window.masterMotionV32","playForMode"]){if(!pg.includes(s))errors.push(`planner bridge missing ${s}`)}
...
console.log("P2 V33.1 SELFCHECK PASSED: return 04->05 chain + evening 06 + awaited keyframes + V34/V32 compatibility + free-only");
