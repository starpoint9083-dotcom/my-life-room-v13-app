...
for(const s of ["/master-motion-v36.js?v=36","/master-motion-v35.js?v=35","window.masterMotionV36||window.masterMotionV35||window.masterMotionV34||window.masterMotionV33||window.masterMotionV32","naturalScore","continuityQC","roughSlotCount","p2:master-motion-v36-ready"]){if(!program.includes(s))errors.push(`V35 planner bridge missing ${s}`)}
...
console.log(`P2 V35 CONTINUITY SELFCHECK PASSED: 50/50 classified; exact=${counts.exact}, adaptive=${counts.adaptive}, end-match=${counts["end-match"]}, start-match=${counts["start-match"]}, soft-transition=${counts["soft-transition"]}, rough=0; V36 compatible; free-only`);
