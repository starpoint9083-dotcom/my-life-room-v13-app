...
for(const s of ["Exactly one adult person only","Remove and do not reproduce any animal or pet","pose-${pose}-clean2.jpg","pose-v20-clean2"])if(!serverVisual.includes(s))errors.push(`server visual missing ${s}`);
