...
function status(){const s=scene()?.status?.()||{},mm=master()?.status?.()||null;return {version:VERSION,running,lastMode,readyScenes:ready().length,currentLocation:s.currentLocation||"home",currentPose:s.currentPose||"standing",recent:[...recent],masterMotion:mm,freeOnly:true}}
